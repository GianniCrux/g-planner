...
export const CardCreator = ({ onClose }: CardCreatorProps) => {
  ...
  const ProgressBar = () => (
    <div className="flex justify-between items-center mb-4 px-1 relative">
      ...
      <div className="h-1 bg-amber-200 dark:bg-amber-700 absolute w-full top-4 left-0 -z-10 rounded-full"></div>
  ...
  return (
    <div className="flex justify-center items-center h-full bg-amber-300 dark:bg-amber-600">
      <Card className="w-[350px] bg-amber-300 border-none dark:bg-amber-800 overflow-hidden">
        ...
        <CardFooter className="flex justify-between pt-2">
          {currentStep > 1 ? (
            <Button 
              variant="outline" 
              className="bg-amber-200 hover:bg-amber-400 border-none dark:bg-amber-700 dark:hover:bg-amber-600 transition-all duration-300" 
              onClick={prevStep}
          ...
          {currentStep < 3 ? (
            <Button 
              className={`bg-amber-400 hover:bg-amber-500 text-black border-none dark:bg-amber-600 dark:text-amber-200 
                dark:hover:bg-amber-500 transition-all duration-300 ${!isStepValid() || isAnimating ? 'opacity-50 cursor-not-allowed' : ''}`}
              onClick={nextStep}
            ...
            <Button 
              className={`bg-amber-400 hover:bg-amber-500 text-black border-none dark:bg-amber-600 dark:text-amber-200 
                dark:hover:bg-amber-500 transition-all duration-300 ${!isStepValid() ? 'opacity-50 cursor-not-allowed' : ''}`}
